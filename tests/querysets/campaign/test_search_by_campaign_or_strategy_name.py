...
@pytest.fixture
def campaigns_with_strategies(db):  # noqa: ARG001
...
@pytest.mark.django_db
def test_filter_search_no_duplicates(campaigns_with_strategies):
...
@pytest.mark.django_db
def test_search_no_duplicates(as_anon, campaigns_with_strategies):
    _, _, camp3 = campaigns_with_strategies
    url = reverse("campaign-list")
